...
FRONTEND_BASE = "http://localhost:3000"  # Frontend runs here
CALLBACK_URL = "http://localhost:3001/api/auth/login/google/callback"
...
# def google_callback():
#     try:
#         print("🔍 Google Callback: Starting...")
#         code = request.args.get("code")
#         print(f"🔍 Google Callback: Code received: {code[:20] if code else 'None'}...")
...
#         session['session_token'] = new_token
#         print(f"🔍 Session token set: {new_token}")
