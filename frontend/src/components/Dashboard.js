...
const Dashboard = () => {
  ...
  const exportToCSV = () => {
    ...
    a.href = url;
    a.download = `price_results_${matchType}.csv`;
            ...
            <div className="results-header">
              <div className="results-info">
                ...
                <p className="results-subtitle">
                  Showing <strong>{filteredResults.length}</strong> (of {results.length}) products
                  <span className="badge-mode">{matchType.toUpperCase()} MATCH</span>
                </p>
              </div>
              ...
              <div className="table-scroll">
                ...
                {results.length > 0 && filteredResults.length === 0 && (
                  <div style={{ padding: '40px', textAlign: 'center', color: '#666' }}>
                    ...
                    No products match your current filters or match type.
                  </div>
                )}
              </div>
            </div>
