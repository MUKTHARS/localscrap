        ...
        <div className="top-left-brand">
          <div className="brand-header-container">
            ...
            <div className="brand-text-header">
              <h1 className="header-brand-title">TutoMart</h1>
              <p className="header-brand-tagline">Scraping Made Easier</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="premium-login-card">
            ...
            <div className="form-header">
              <h2 className="form-title">
                {isLogin ? 'Sign In to TutoMart' : 'Create Account'}
              </h2>
              <p className="form-subtitle">
                {isLogin ? 'Enter your credentials to access your account' : 'Join TutoMart to start your learning journey'}
              </p>
            </div>

            {/* Message Alert */}
            {message && (
              <div className={`premium-alert ${message.includes('error') || message.includes('do not match') ? 'alert-error' : 'alert-success'}`}>
                <div className="alert-icon">
                  <i className={`bi ${message.includes('error') || message.includes('do not match') ? 'bi-exclamation-triangle' : 'bi-check-circle'}`}></i>
                </div>
